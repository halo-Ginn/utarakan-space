...
export const metadata = { title: 'Berikan Dukungan/Tip via QRIS — Utarakan.space' }

export default function QrisPage() {
    return (
        <section className="section" style={{ maxWidth: '560px', margin: '0 auto', textAlign: 'center' }}>
            <h1 className="font-serif text-3xl mb-2" style={{ color: '#2d3b2d' }}>Berikan Dukungan/Tip via QRIS</h1>
            ...
            <div className="card-copper" style={{ display: 'inline-block', padding: '20px' }}>
                <img
                    src="/qris.jpg"
                    alt="QRIS Utarakan — scan untuk memberikan dukungan/tip"
            ...
            <div className="text-left mt-8 space-y-3 text-base leading-relaxed" style={{ color: '#3d4d3d' }}>
                <p><strong>Cara memberikan dukungan/tip:</strong></p>

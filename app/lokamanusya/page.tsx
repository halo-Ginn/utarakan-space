                    ...
                    {id ? (
                        <>
                            ...
                            <p>Kami sedang menyiapkannya dengan hati-hati. Sambil menunggu, kamu bisa mengikuti perjalanan kami di Instagram{' '}
                                <a href="https://www.instagram.com/utarakan.by.lokamanusya" target="_blank" rel="noopener noreferrer"
                                    style={{ color: '#b87333', textDecoration: 'underline' }}>@utarakan.by.lokamanusya</a>{' '}
